...
export default function Header({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 flex flex-col px-6 md:px-10 ${
          imageUrl ? "min-h-screen py-12" : "mt-10"
        }`}
      >
        <div className="my-auto py-14 w-full lg:w-[58%] lg:mr-auto">
          <div className="w-full max-w-5xl mx-auto">
            ...
            <p className="text-base md:text-xl leading-relaxed">{intro}</p>
          </div>
        </div>
      </div>
    </HeroFade>
